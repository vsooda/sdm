...
int main()
{
    ...
    vector<HoGParam> HoGParams{{ VlHogVariant::VlHogVariantUoctti, 4, 10, 4, 0.7f },{ VlHogVariant::VlHogVariantUoctti, 4, 9, 4, 0.5f },{ VlHogVariant::VlHogVariantUoctti, 4, 6, 4, 0.2f } };
    vector<LinearRegressor> LinearRegressors(3);
